...
class AppTextStyles {
  ...
  static TextStyle font24MainBlue700Weight = TextStyle(
    fontSize: 24.sp,
    fontWeight: FontWeight.w700,
    color: AppColors.mainBlue,
  );
  ...
  static TextStyle font11Black500Weight = TextStyle(
    fontSize: 11.sp,
    fontWeight: FontWeight.w500,
    color: Colors.black,
  );
  ...
  static TextStyle font11MainBlue600Weight = TextStyle(
    fontSize: 11.sp,
    fontWeight: FontWeight.w600,
    color: AppColors.mainBlue,
  );

  static TextStyle font12MainBlue400Weight = TextStyle(
    fontSize: 12.sp,
    fontWeight: FontWeight.w400,
    color: AppColors.mainBlue,
  );
